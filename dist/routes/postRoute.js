        ...
        if (req.headers.token) { //truthy (if the token exists .. do this:)
            try {
                ...
                if (tokenPayload.userId === req.body.userId) {
                    ...
                    posts_1.postArray.push(new posts_1.Posts(++id, req.body.createdDate, req.body.title, req.body.content, req.body.userId, req.body.headerImage, today.toISOString().slice(0, 10)));
